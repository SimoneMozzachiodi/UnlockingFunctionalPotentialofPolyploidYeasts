...
refSetVar1364 <- read.table(file= paste(pathVcfparents, paste("OS1364S288c.Filtvarp3.vcf"), sep="")) 
  
myChr <- c("chrI","chrII","chrIII","chrIV","chrV","chrVI","chrVII","chrVIII","chrIX","chrX",
...
mySample <- c("D287R097","D287R098","D287R099",
              "D287R100","D287R101","D287R112","D287R113","D287R114","D287R115","D287R116","D287R117",
              "D287R118","D287R119","D287R120","D287R121","D287R122","D287R123","D287R124","D287R125","D287R126","D287R127",
              "D287R128","D287R129","D287R130","D287R131","D287R146","D287R147","D287R148","D287R149",
              
              "D287R104","D287R132","D287R133","D287R134","D287R135","D287R136","D287R137","D287R138",
              "D287R139","D287R157","D287R158","D287R169","D287R170","D287R163","D287R164","D287R165","D287R166",
              
              "D287R102","D287R140","D287R141","D287R142","D287R143","D287R144","D287R145",
              "D287R150","D287R151","D287R152","D287R153","D287R154","D287R155","D287R156",
              
              "D167R74","D167R75","D167R76","D167R77","D167R78","D167R79","D167R80" 
)
...
vcfSample <- read.table(file= paste(pathVcf,indSample,paste(indSample,"S288c", sep=""), paste(indSample, ".p3.isec.var.vcf", sep=""), sep="/")) 
...
indexLOHseg <- which(lengths(groupMark) >= 10)
...
write.table(x=LOHsummary, file="/home/smozzachiodi/Batch2RTG-OS1364/mappResuStnd/LOH_summary_10markers_15052020.csv")
...
dfLOHmarkerUpd <- dfLOHmarkerUpd[which(dfLOHmarkerUpd$AFshift != 0.666667 ),]
dfLOHmarkerUpd <- dfLOHmarkerUpd[which(dfLOHmarkerUpd$AFshift != -0.666667 ),]
...
write.table(dfLOHmarkerUpdPlot, file="/home/smozzachiodi/Batch2RTG-OS1364/mappResuStnd/RTG_OS1364_markerStatus_10mark_11052020",sep = ",")

myChr <- c("chrI", "chrII", "chrIII", "chrIV", "chrV", "chrVI", "chrVII", "chrVIII",
           "chrIX", "chrX", "chrXI", "chrXII", "chrXIII", "chrXIV", "chrXV", "chrXVI")

pdf("/home/smozzachiodi/Batch2RTG-OS1364/mappResuStnd/OS1364.LOH.10markers.pdf", height = 6, width = 12)
plot(c(0,0),c(0,0),xlim=c(0,12071326),ylim=c(0,2640), yaxt = 'n', xaxt='n',ann=FALSE, bty = 'n')
n <-0
